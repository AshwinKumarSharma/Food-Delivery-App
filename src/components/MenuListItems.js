                    ...
                    <div className="w-3/12 p-4">
                        ...
                        <>
                            <div className="absolute">
                                <button className="px-6 py-1 mx-7 my-20 font-semibold text-green-600 border border-gray-200 rounded-md bg-white shadow-lg" onClick={() => handleAddItem(items)}>ADD +</button>
                            </div>
                            <img className="w-full h-24 rounded-lg" src={CDN_IMG+items.card.info.imageId}/>
                        </> : 
                            <button className="px-6 py-1 font-semibold text-green-600 border border-gray-200 rounded-md bg-white shadow-lg" onClick={() => handleAddItem(items)}>ADD +</button>}
                    </div>
                </div>
            ))}
        </div>
